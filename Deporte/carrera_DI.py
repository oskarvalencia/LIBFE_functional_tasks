...
f1= ciclosL[30:120,:] # izquierda
f2= ciclosR[150:240,:] # derecha
...
ax1.plot(t1,normal.lhipangz,'k',markersize=0.8, linewidth=1)
ax1.plot(t1,ave(f1[0:10,:]),'r--',markersize=0.8, linewidth=1)
ax1.plot(t1,ave(f2[0:10,:]),'g--',markersize=0.8, linewidth=1)
...
ax2.plot(t1,normal.lkneeangz,'k',markersize=0.8, linewidth=1)
ax2.plot(t1,ave(f1[30:40,:]),'r--',markersize=0.8, linewidth=1)
ax2.plot(t1,ave(f2[30:40,:]),'g--',markersize=0.8, linewidth=1)
...
ax3.plot(t1,normal.lankleangz,'k',markersize=0.8, linewidth=1)
ax3.plot(t1,ave(f1[60:70,:]),'r--',markersize=0.8, linewidth=1)
ax3.plot(t1,ave(f2[60:70,:]),'g--',markersize=0.8, linewidth=1)
...
ax4.plot(t1,normal.lhipangx,'k',markersize=0.8, linewidth=1)
ax4.plot(t1,ave(f1[10:20,:]),'r--',markersize=0.8, linewidth=1)
ax4.plot(t1,ave(f2[10:20,:]),'g--',markersize=0.8, linewidth=1)
ax4.fill_between(t1,normal.lhipangx + normal.lhipangx_sd,normal.lhipangx - normal.lhipangx_sd, color='silver')


ax5.plot(t1,normal.lkneeangx,'k',markersize=0.8, linewidth=1)
ax5.plot(t1,ave(f1[40:50,:]),'r--',markersize=0.8, linewidth=1)
ax5.plot(t1,ave(f2[40:50,:]),'g--',markersize=0.8, linewidth=1)
ax5.fill_between(t1,normal.lkneeangx + normal.lkneeangx_sd,normal.lkneeangx - normal.lkneeangx_sd, color='silver')

#ax5.set_xlim(0,47)
ax6.plot(t1,normal.lankleangx,'k',markersize=0.8, linewidth=1)
ax6.plot(t1,ave(f1[70:80,:]),'r--',markersize=0.8, linewidth=1)
ax6.plot(t1,ave(f2[70:80,:]),'g--',markersize=0.8, linewidth=1)
ax6.fill_between(t1,normal.lankleangx + normal.lankleangx_sd,normal.lankleangx - normal.lankleangx_sd, color='silver')

#ax6.set_xlim(0,47)
ax7.plot(t1,normal.lhipangy,'k',markersize=0.8, linewidth=1)
ax7.plot(t1,ave(f1[20:30,:]),'r--',markersize=0.8, linewidth=1)
ax7.plot(t1,ave(f2[20:30,:]),'g--',markersize=0.8, linewidth=1)
ax7.fill_between(t1,normal.lhipangy + normal.lhipangy_sd,normal.lhipangy - normal.lhipangy_sd, color='silver')

#ax7.set_xlim(0,47)
ax8.plot(t1,normal.lkneeangy,'k',markersize=0.8, linewidth=1)
ax8.plot(t1,ave(f1[50:60,:]),'r--',markersize=0.8, linewidth=1)
ax8.plot(t1,ave(f2[50:60,:]),'g--',markersize=0.8, linewidth=1)
ax8.fill_between(t1,normal.lkneeangy + normal.lkneeangy_sd,normal.lkneeangy - normal.lkneeangy_sd, color='silver')
#ax8.set_xlim(0,47)

ax9.plot(t1,normal.lankleangy,'k',markersize=0.8, linewidth=1)
ax9.plot(t1,ave(f1[80:90,:]),'r--',markersize=0.8, linewidth=1)
ax9.plot(t1,ave(f2[80:90,:]),'g--',markersize=0.8, linewidth=1)
